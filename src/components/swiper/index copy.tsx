...
export default class extends Component {
  ...
  scrollTo = (index, animated = true) => {
    ...
    this.scrollView && this.scrollView.current.scrollTo({ x, y, animated });
  ...
  renderTitle = () => {
    ...
    return title ? (
      <View style={styles.title}>{this.state.children[this.state.index].props.title}</View>
    ) : null;
  };
